...
#define STRING_CONFIG_H_AUTHOR "(misiakw, Sapphire Pro)" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 1 // Set 1 for stock thermistor
...
#define TEMP_SENSOR_BED 1 // For Standard heater set to 1
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 30, 70 }
